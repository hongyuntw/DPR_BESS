...
<<<<<<< HEAD
                    ...
                    self.augument_tensorizer.text_to_tensor(q)
=======
                    self.tensorizer.text_to_tensor(q)
>>>>>>> 892e63999c2f7b4b9f710ef70d4e95c8d306956e
...
<<<<<<< HEAD
                ...
                q_attn_mask = self.augument_tensorizer.get_attn_mask(q_ids_batch)
=======
                q_attn_mask = self.tensorizer.get_attn_mask(q_ids_batch)
>>>>>>> 892e63999c2f7b4b9f710ef70d4e95c8d306956e
...
<<<<<<< HEAD
    tensorizer, encoder, _ , augument_tensorizer = init_biencoder_components(
=======
...
>>>>>>> 892e63999c2f7b4b9f710ef70d4e95c8d306956e
    ...
    #     model_path = f'results/movieQA_cn_training_weight_only_cosine_28/dpr_biencoder.{epoch}.3018'
    #     saved_state = load_states_from_checkpoint(model_path)
    #     for (key, value) in saved_state.model_dict.items():
    #         if key.startswith("question_model."):
    #             if key[prefix_len:] in question_encoder_state:
    #                 question_encoder_state[key[prefix_len:]] += value
    #             else:
    #                 question_encoder_state[key[prefix_len:]] = value
    # question_encoder_state = {k : v/5 for k, v in question_encoder_state.items()}
    ...
    retriever = DenseRetriever(encoder, args.batch_size, tensorizer, augument_tensorizer , index)
